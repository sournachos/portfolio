...
<section id="work" class="work">
    <h1>Work</h1>
        <div class="workbox">
            ...
            <div class="work2">
                <figure><a href="https://github.com/sournachos/XP-Arcade-PROJECT2" target="_blank"><img src={`${process. env. PUBLIC_URL}/images/project2demo.png`} alt="Image shows the background image of Windows XP"/></a>
                    <h3>XP Arcade<br/>
